<?php
   ...
   $sql = " insert into answerpythonquiz (name,email,Q1) values ('$name','$email','$Q1')";
		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                ...
		                <div class="card wizard-card" data-color="orange" id="wizardProfile">
		                    <form action="demo3.php" id="form" method="POST">
		                <!--        You can switch " data-color="orange" "  with one of the next bright colors: "blue", "green", "orange", "red", "azure"          -->
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="1">
		                            	<div class="row">
											 <h3 class="info-text">2.What is the Output of the Following code:-</h3>
   												 <pre>L1 = list()<br>L1.append([1,[2,3],4])<br>L1.extend([7,8,9])<br>print(L1[0][1][1]+L1[2]) </pre>
													
											
											<div class="col-sm-6">
												<div class="form-group">
													<input type="radio" value="Typeerror" id="Fastlearning" name="Q2">
       												<label for="Fastlearning">Type Error: Can only concatenate List</label><br/>
    											<input type="radio" value="12" name="Q2">
       												<label> 12</label><br/>
    											<input type="radio" value="11" name="Q2">
       												<label>11</label> <br/>
    											<input type="radio" value="38" name="Q2">
     												<label> 38</label>
